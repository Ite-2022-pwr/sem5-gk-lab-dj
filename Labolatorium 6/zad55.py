...
current=0
face = True
image1 = Image.open("egg.tga")
image2 = Image.open("egg2.tga")
...
def main():
    ...
    glfwSwapInterval(1)
    tab = [[[0] * 8 for i in range(N + 1)] for j in range(N + 1)]
    for u in range(N + 1):
        for v in range(N + 1):
            pu = u / N
            pv = v / N
